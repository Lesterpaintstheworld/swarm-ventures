...
# Initialize bot application with proper event loop handling
application = None
...
# Use this function to get the application instance
...
async def subscribe_command(update: Update, context):
    ...
    subscription_message = (
        ...
        f"🔗 Get Premium: https://swarmventures.universalbasiccompute.ai/premium?ref={user_id}\n\n"
